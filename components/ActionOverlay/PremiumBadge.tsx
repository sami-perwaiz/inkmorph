...
/** Pro crown badge — Figma 40004700:9498 (28×28, 16px inset, 16px crown). */
export function PremiumBadge() {
  return (
    <div
      className="pointer-events-none absolute z-20 flex items-center justify-center shadow-[0px_8px_4px_rgba(10,13,18,0.03),0px_20px_12px_rgba(10,13,18,0.08)]"
      style={{
